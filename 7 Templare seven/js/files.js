...
nightBtn.onclick = function(){
    if(night === false){
        nightBtn.style.cssText = `
            ...
            document.querySelector(".files-stats").style.backgroundColor = "var(--night-color)";
            document.querySelector(".files-stats").style.color = "white";
        ...
        document.querySelector(".files-stats").style.backgroundColor = "white";
        document.querySelector(".files-stats").style.color = "black";
        document.querySelectorAll("aside li a").forEach((a)=>{
